  ...
  return (
    <div>
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 pt-20 pb-24 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pt-28">
          <div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link
                href="/register"
                className="rounded-md bg-gradient-sunset px-6 py-3 font-medium text-white shadow-lg shadow-violet/20 hover:opacity-90"
              >
                Start issuing tickets
              </Link>
              <Link
                href="/marketplace"
                className="rounded-md border border-border-bright px-6 py-3 font-medium hover:bg-surface"
              >
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
            {INDUSTRIES.map((industry) => {
              ...
              return (
                <div
                  key={industry}
                  className="flex items-center gap-3 rounded-xl border border-border bg-background px-4 py-4 transition-colors hover:border-border-bright"
                >
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <Link
              href="/security"
              className="mt-6 inline-block text-sm font-medium text-gradient hover:underline"
            >
      ...
      <section className="border-t border-border bg-surface/60">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          <h2 className="font-heading text-3xl font-bold sm:text-4xl">
            Build the world&apos;s ticketing infrastructure with us
          </h2>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href="/about" className="rounded-md border border-border-bright px-6 py-3 font-medium hover:bg-surface">
              Learn more
            </Link>
          </div>
        </div>
